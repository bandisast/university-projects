...
{&(RES0__INSTANCE0.INPUT_CONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE0.START_BUTTON), BOOL_ENUM},
{&(RES0__INSTANCE0.STOP_BUTTON), BOOL_ENUM},
{&(RES0__INSTANCE0.MACHINING_EXIT_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_ISMOVINGX), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_ISMOVINGZ), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_ISLEFTLIM), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_ISMIDLIM), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_ISRIGHTLIM), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.DOOR_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.EMERGENCY_STOP), BOOL_ENUM},
{&(RES0__INSTANCE0.MACHINING_START), BOOL_ENUM},
{&(RES0__INSTANCE0.MACHINING_PRODUCELIDS), BOOL_ENUM},
{&(RES0__INSTANCE0.TRANSFER_CONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE0.EXIT_CONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE0.EMITTER_EXIT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_LIFT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_LEFT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_RIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE_LOADING_CONVEYOR), BOOL_ENUM},
{&(RES0__INSTANCE0.START_LIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.STOP_LIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.WARNING_LIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.SIREN), BOOL_ENUM},
{&(RES0__INSTANCE0.MACHINING_STOP), BOOL_ENUM},
{&(RES0__INSTANCE0.MACHINING_RESET), BOOL_ENUM},
{&(RES0__INSTANCE0.MACHINING_ISBUSY), INT_ENUM},
{&(RES0__INSTANCE0.POTENTIOMETER), INT_ENUM},
{&(RES0__INSTANCE0.CRANE_POSITION), INT_ENUM},
{&(RES0__INSTANCE0.INPUT_CONVEYOR_ALG), INT_ENUM},
{&(RES0__INSTANCE0.CURRENT_BASE), INT_ENUM},
{&(RES0__INSTANCE0.CURRENT_LID), INT_ENUM},
{&(RES0__INSTANCE0.TOTAL_BASE), INT_ENUM},
{&(RES0__INSTANCE0.TOTAL_LID), INT_ENUM},
...
{&(RES0__INSTANCE0.LIDS0.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.LIDS0.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.LIDS0.LIDTYPE), BOOL_ENUM},
{&(RES0__INSTANCE0.LIDS0.SIGNAL), BOOL_ENUM},
...
{&(RES0__INSTANCE0.CRANE0.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.IN_SENSOR), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.IN_MIDLIM), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.WORD_TO_SHIFT), INT_ENUM},
{&(RES0__INSTANCE0.CRANE0.IN_MOVEX), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.IN_MOVEZ), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMEIN), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.IN_RIGHTLIM), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.IN_LEFTLIM), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.ISLID), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMEPT), TIME_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.EN), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.IN), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.PT), TIME_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.Q), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.ET), TIME_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.STATE), SINT_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.PREV_IN), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.CURRENT_TIME), TIME_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMERON.START_TIME), TIME_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMEQ), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.OUT_LIFT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.OUT_LEFT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.OUT_RIGHT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.OUT_TARGETPOSITION), INT_ENUM},
{&(RES0__INSTANCE0.CRANE0.LOADING_CONV_LOADED), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.STACKER_BUSY), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.LEFT_CONV_WAIT), BOOL_ENUM},
{&(RES0__INSTANCE0.CRANE0.DESTINATION), INT_ENUM},
{&(RES0__INSTANCE0.CRANE0.TIMEET), TIME_ENUM},
...
{&(RES0__INSTANCE0.MOVE18_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.MOVE18_OUT), INT_ENUM},
{&(RES0__INSTANCE0.MOVE65_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.MOVE65_OUT), INT_ENUM},
{&(RES0__INSTANCE0.INT_TO_BOOL23_OUT), BOOL_ENUM},
...
{&(RES0__INSTANCE0.EQ15_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0.AND62_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0.AND19_OUT), BOOL_ENUM},
...
{&(RES0__INSTANCE0.INT_TO_BOOL14_OUT), BOOL_ENUM},
...
{&(RES0__INSTANCE0.EQ4_OUT), BOOL_ENUM},
{&(RES0__INSTANCE0.ADD105_OUT), INT_ENUM},
{&(RES0__INSTANCE0.MOVE82_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.MOVE82_OUT), INT_ENUM},
{&(RES0__INSTANCE0.ADD103_OUT), INT_ENUM},
{&(RES0__INSTANCE0.MOVE68_ENO), BOOL_ENUM},
{&(RES0__INSTANCE0.MOVE68_OUT), INT_ENUM},
{&(RES0__INSTANCE0.MOVE50_OUT), INT_ENUM},
...
{&(RES0__INSTANCE0.MOVE100_OUT), INT_ENUM},
...
{&(RES0__INSTANCE0.MOVE93_OUT), INT_ENUM}
};
